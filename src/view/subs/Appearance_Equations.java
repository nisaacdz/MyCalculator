...
public class Appearance_Equations extends Appearance {
	...
	public Appearance_Equations() {
		...
		// TODO backward.addActionListener(new EqnListener(this));
		...
		// TODO forward.addActionListener(new EqnListener(this));
		...
		// TODO times.addActionListener(new EqnListener(this));
		...
		// TODO divide.addActionListener(new EqnListener(this));
		...
		// TODO plus.addActionListener(new EqnListener(this));
		...
		// TODO minus.addActionListener(new EqnListener(this));
		...
		// TODO solve.addActionListener(new AnsListener(this));
		...
		// TODO varX.addActionListener(new EqnListener(this));
		...
		// TODO varY.addActionListener(new EqnListener(this));
		...
		// TODO varZ.addActionListener(new EqnListener(this));
		...
		// TODO backspace.addActionListener(new EqnListener(this));
		...
		// TODO clear.addActionListener(new EqnListener(this));
		...
		// TODO open.addActionListener(new EqnListener(this));
		...
		// TODO close.addActionListener(new EqnListener(this));
		...
		// TODO exponent.addActionListener(new EqnListener(this));
		...
		// TODO equal.addActionListener(new EqnListener(this));
		...
		// TODO period.addActionListener(new EqnListener(this));
	...
	private void init(final JButton button) {
		...
		if (txt.equals("1") || txt.equals("2") || txt.equals("3")) {
			y = 335;
		}
		if (txt.equals("4") || txt.equals("5") || txt.equals("6")) {
			y = 280;
		}
		if (txt.equals("7") || txt.equals("8") || txt.equals("9")) {
			y = 225;
		}
		if (txt.equals("1") || txt.equals("4") || txt.equals("7")) {
			x = 0;
		}
		if (txt.equals("2") || txt.equals("5") || txt.equals("8")) {
			x = 60;
		}
		if (txt.equals("3") || txt.equals("6") || txt.equals("9")) {
			x = 120;
		}
		...
		// TODO button.addActionListener(new EqnListener(this));
		this.add(button);
	}
